...
@section('title', 'Pendaftaran Seleksi Mandiri Tahap 3')
@section('js')
<script>
  document.querySelector("#upload_sertifikat_utbk_snbt").onchange = function() {
    const fileName = this.files[0].name;
    const label = document.querySelector("label[for=upload_sertifikat_utbk_snbt]");
...
@section('content')
  ...
  <div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
      <!--begin::Form-->
      <form id="myForm" class="form" action="{{ route('storetahap3') }}" method="POST" enctype="multipart/form-data">@csrf
        <!--begin::Card body-->
            ...
            <div class="col-lg-8">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 fv-row">
                  <input type="text" name="name" value="{{ $mhs->name ?? old('name') }}" class="form-control form-control-lg" />
                </div>
                <!--end::Col-->
              </div>
              <!--end::Row-->
          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              ...
              <div class="row">
                <!--begin::Col-->
                <div class="col-lg-12 fv-row">
                  <input readonly type="text" name="nisn" value="{{ $nisn ?? old('nisn') }}" class="form-control form-control-lg" />
                </div>
                <!--end::Col-->
              </div>
              <!--end::Row-->
            ...
            <div class="col-lg-8">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6 fv-row">
                  <label for="upload_sertifikat_utbk_snbt" class="btn btn-info mb-3 mb-lg-0">Upload Sertifikat UTBK-SNBT</label>
                  <input type="file" style="display:none;" name="upload_sertifikat_utbk_snbt" id="upload_sertifikat_utbk_snbt" class="form-control form-control-lg form-control-solid">
                  @if ($mhs && $mhs->upload_kartu)
                    <br><span class="text-info">Kartu Ujian Anda : <a href="{{ asset('upload_kartu/'.$mhs->upload_kartu) }}">Lihat</a></span>
                  @endif
                  <br><span class="text-danger">*Upload Sertifikat Nilai Hasil UTBK-SNBT 2024</span>
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col-lg-6 fv-row">
                  ...
                  @if ($mhs && $mhs->upload_resi)
                    <br><span class="text-info">Resi Pembayaran Anda : <a href="{{ asset('upload_resi/'.$mhs->upload_resi) }}">Lihat</a></span>
                    <br><span class="text-danger">Resi pembayaran MANDIRI TAHAP 3. Tulis Nama dan NISN</span>
                  @else
                    <br><span class="text-danger">Resi pembayaran MANDIRI TAHAP 3. Tulis Nama dan NISN</span>
                  @endif
                </div>
